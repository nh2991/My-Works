...
poll <- read.csv("/Users/user/Desktop/Yonsei/Junior/R & Python Programming/3-2 SelfStudy/Others/poll/Poll_June.csv")
...
ggplot(data=poll, aes(x=President.Bad, y=Theminjoo, colour=Institute, size=Day)) +
  ...
  labs(title='대통령 부정평가와 더불어민주당 지지율', subtitle='2023년 6월', 
...
ggplot(data=poll, aes(x=President.Good, y=PPP, colour=Institute, size=Day)) +
  ...
  guides(col=guide_legend(ncol=2)) +
  theme(legend.position='right') + 
  labs(title='대통령 긍정평가와 국민의힘 지지율', subtitle='2023년 6월', 
...
ggplot(data=poll, aes(x=PPP, y=Theminjoo, colour=Institute, size=Day)) +
  ...
  guides(col=guide_legend(ncol=2)) +
  labs(title='더불어민주당과 국민의힘 지지율', subtitle='2023년 6월\n\n(더불어민주당 - 국민의힘) (%)', 
...
ggplot(data=poll, aes(x=President.Good, y=President.Bad, colour=Institute, size=Day)) +
  ...
  guides(col=guide_legend(ncol=2)) +
  labs(title='대통령 긍정평가와 부정평가', subtitle='2023년 6월\n\n(부정평가 - 긍정평가) (%)', 
