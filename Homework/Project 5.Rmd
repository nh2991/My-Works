...
\noindent $\beta < 0$ would be eliminated.
...
\noindent Order with $C_i$, descending.
...
\noindent 1. Short Sales are Allowed
...
\noindent Thus, the last column is the percentage of each stock.  
